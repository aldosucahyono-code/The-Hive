  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="mt-1 text-neutral-400">{t.chooseAnalysisType.subtitle}</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-neutral-300">{t.chooseAnalysisType.newDesc}</p>
        </button>
        ...
        >
          ...
          <p className="text-sm leading-relaxed text-neutral-300">{t.chooseAnalysisType.runningDesc}</p>
        </button>
