...
const id = {
  ...
  chatFlow: {
    ...
    askPerizinanUsaha: "Soal perijinan, gimana kondisinya? Misalnya NIB, sertifikat halal, atau izin lain — sudah ada, masih proses, atau belum sama sekali? Santai saja kalau belum ada.",
    askJumlahTim: "Berapa jumlah orang yang bantu jalanin bisnis ini sekarang? (termasuk kamu sendiri, boleh tulis 'sendirian' kalau memang belum ada tim)",
...
const en: Translations = {
  ...
  chatFlow: {
    ...
    askPerizinanUsaha: "How's it going with permits/licenses? For example business registration (NIB), halal certificate, or other permits — already have them, still in process, or none yet? No worries if you don't have any yet.",
    askJumlahTim: "How many people are helping run this business right now? (including yourself — feel free to say 'just me' if there's no team yet)",
