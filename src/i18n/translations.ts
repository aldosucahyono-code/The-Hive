...
const id = {
  ...
  workspace: {
    ...
    chatGreetingThinking: "Saya sedang meninjau bisnis Anda...",
    ...
    todayMissionDoneNote: "Ditandai selesai untuk hari ini — tersimpan di perangkat ini sampai besok atau sampai prioritasmu berganti.",
    todayMissionWhyToggle: "Kenapa ini prioritas?",
    todayMissionWhyHide: "Sembunyikan alasan",
    todayMissionLaterButton: "Nanti Saja",
    todayMissionLaterNote: "Oke, ditunda dulu — tombol \"Mulai Kerjakan\" tetap aktif kalau berubah pikiran.",
    todayOtherPrioritiesTitle: "Prioritas Lainnya",
    todayOtherPrioritiesSubtitle: "Selain fokus utama di atas, Beemo juga memantau beberapa hal ini untuk bisnismu minggu ini.",
  ...
  workspaceHome: {
    ...
    categoryAutoHint: "Kategori ini dikenali otomatis dari informasi bisnis yang kamu berikan.",
    ...
    googlePresenceTitle: "Buat bisnismu lebih mudah ditemukan di Google",
    googlePresenceDesc: "Banyak pelanggan baru menemukan bisnis lewat Google. Paket ini membantu kamu menyiapkan profil yang lebih lengkap.",
    ...
    nextStepsTitle: "Setelah paket ini selesai",
    nextStepsItem1: "Tempelkan deskripsi di atas ke Google Business Profile kamu",
    nextStepsItem2: "Ambil minimal 5 foto pertama sesuai rekomendasi angle-nya",
    nextStepsItem3: "Lengkapi checklist data di atas",
    nextStepsItem4: "Kembali ke sini dan cerita ke Beemo hasilnya",
  },
};
...
const en: Translations = {
  ...
  workspace: {
    ...
    chatGreetingThinking: "I'm reviewing your business...",
    ...
    todayMissionDoneNote: "Marked done for today — saved on this device until tomorrow or until your priority changes.",
    todayMissionWhyToggle: "Why this priority?",
    todayMissionWhyHide: "Hide reason",
    todayMissionLaterButton: "Later",
    todayMissionLaterNote: "Got it, deferred for now — the \"Get Started\" button still works if you change your mind.",
    todayOtherPrioritiesTitle: "Other Priorities",
    todayOtherPrioritiesSubtitle: "Besides the main focus above, Beemo is also keeping an eye on a few other things for your business this week.",
  ...
  workspaceHome: {
    ...
    categoryAutoHint: "This category is detected automatically from the business info you provided.",
    ...
    googlePresenceTitle: "Make your business easier to find on Google",
    googlePresenceDesc: "Many new customers find businesses through Google. This package helps you prepare a more complete profile.",
    ...
    nextStepsTitle: "After finishing this package",
    nextStepsItem1: "Paste the description above into your Google Business Profile",
    nextStepsItem2: "Take at least the first 5 photos following the suggested angles",
    nextStepsItem3: "Complete the checklist above",
    nextStepsItem4: "Come back here and tell Beemo how it went",
  },
};
