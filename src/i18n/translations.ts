...
const id = {
  ...
  workspace: {
    ...
    finalReportsBaselineDesc: "Rangkuman total analisa pertama bisnismu — titik acuan (baseline) untuk mengukur semua progres berikutnya.",
    ...
    finalReportsExpiryDesc: "Perbandingan semua yang telah kamu lakukan sepanjang periode akses, beserta kesimpulannya — jadi acuan target periode berikutnya kalau kamu berlangganan lagi.",
...
const en: Translations = {
  ...
  workspace: {
    ...
    finalReportsBaselineDesc: "A full summary of your business's first-ever analysis — the baseline all future progress is measured against.",
    ...
    finalReportsExpiryDesc: "A comparison of everything you did during your access period, with a conclusion — becomes the baseline target for your next period if you resubscribe.",
