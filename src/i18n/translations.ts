...
const id = {
  ...
  stepTwo: {
    ...
    perizinanUsahaPlaceholder: "Contoh : NIB sudah, sertifikat halal belum — atau tulis 'belum ada'",
    jumlahTimPlaceholder: "Contoh : 2 orang",
    formError: "Periksa kembali kolom yang ditandai ⚠ sebelum lanjut.",
  },
  ...
  pricing: {
    ...
    proChecklist: [
      "Laporan analisa bisnis lengkap (PDF & tampilan interaktif)",
      "Kekuatan-kelemahan bisnis, kondisi pasar & pesaing di sekitarmu",
      "Target harian, target omzet & titik balik modal",
      "SOP & daftar tugas operasional",
  ...
  chatFlow: {
    ...
    askPerizinanUsaha: "Ngomong-ngomong soal legalitas, gimana kondisi perizinan bisnis kamu? Misalnya NIB atau izin usaha lainnya — sudah punya, masih diurus, atau belum ada sama sekali? Santai saja kalau belum ada.",
    askJumlahTim: "Sekarang bisnis ini kamu jalankan sendiri atau sudah ada tim yang bantu? Kalau ada, kira-kira berapa orang?",
    ...
    modalAwalLabel: "Estimasi Modal Awal",
    omsetLabel: "Omset Bulanan Saat Ini",
    perizinanUsahaLabel: "Perijinan Usaha",
    jumlahTimLabel: "Jumlah Tim",
    tantanganTargetTitle: "Tantangan & Target",
    tantanganLabel: "Tantangan Terbesar",
    targetLabel: "Target/Harapan",
...
const en: Translations = {
  ...
  stepTwo: {
    ...
    perizinanUsahaPlaceholder: "e.g. Business registration (NIB) done, halal certificate not yet — or just write 'none yet'",
    jumlahTimPlaceholder: "e.g. 2 people",
    formError: "Please check the fields marked ⚠ before continuing.",
  },
  ...
  pricing: {
    ...
    proChecklist: [
      "Full business analysis report (PDF & interactive view)",
      "Strengths & weaknesses, market conditions & nearby competitors",
      "Daily target, revenue target & break-even point",
      "SOP & operational To-Do List",
  ...
  chatFlow: {
    ...
    askPerizinanUsaha: "By the way, how's it going with the legal side — do you have a business license (like an NIB) or other permits? Already have them, still working on it, or none yet? No worries if you don't have any.",
    askJumlahTim: "Right now, are you running this business solo or do you already have a team helping out? If there's a team, roughly how many people?",
    ...
    modalAwalLabel: "Estimated Starting Capital",
    omsetLabel: "Current Monthly Revenue",
    perizinanUsahaLabel: "Business Permits",
    jumlahTimLabel: "Team Size",
    tantanganTargetTitle: "Challenge & Target",
    tantanganLabel: "Biggest Challenge",
    targetLabel: "Target/Hopes",
