...
const id = {
  ...
  pricing: {
    ...
    earlyBirdBadge: "🔥 Harga Early Bird — naik setelah kuota awal penuh",
    proPriceMonthly: "Rp99.000",
    proPriceMonthlyUnit: "/bulan",
    proPriceAnnual: "atau Rp999.000/tahun",
    proPriceAnnualNote: "hemat ~16% — harga early bird, berlaku untuk pelanggan pertama",
    platinumPriceMonthly: "Rp349.000",
    platinumPriceMonthlyUnit: "/bulan",
    platinumPriceAnnual: "atau Rp3.888.888/tahun",
    platinumPriceAnnualNote: "hemat ~7% — harga early bird, berlaku untuk pelanggan pertama",
  ...
  workspace: {
    ...
    scoreTeaserLockedDesc: "Ini baru 1 dari 6 dimensi ({dimension}). {count} dimensi lainnya + penjelasan lengkapnya terkunci — upgrade untuk lihat semua.",
...
const en: Translations = {
  ...
  workspace: {
    ...
    scoreTeaserLockedDesc: "This is just 1 of 6 dimensions ({dimension}). The other {count} dimensions + full explanations are locked — upgrade to see all of them.",
