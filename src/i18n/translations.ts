...
const id = {
  ...
  chatFlow: {
    ...
    askEmail: "Senang kenalan denganmu! 😊 Boleh minta emailmu? Bukti pembayaran nanti dikirim ke sini.",
    askProfesi: "Kamu berperan sebagai apa di bisnis ini? (misalnya Founder, Owner, Manager)",
    askNamaBisnis: "Apa nama bisnis atau brand kamu?",
    askJenisBisnis: "Bisnis kamu bergerak di bidang apa? (misalnya Coffee Shop, Retail, Jasa Konsultasi)",
    askLokasiNew: "Di mana rencana lokasi bisnis kamu?",
    askLokasiRunning: "Di mana lokasi bisnis kamu sekarang?",
    ...
    askTantanganNew: "Apa tantangan terbesar yang kamu hadapi dalam merintis bisnis ini?",
    askTantanganRunning: "Apa tantangan terbesar bisnis kamu saat ini?",
    askTarget: "Apa target atau harapan besar kamu untuk bisnis ini dalam 6-12 bulan ke depan?",
    askCeritaVisi:
      "Terakhir, boleh cerita lebih personal? Ceritakan kondisi kamu saat ini, impian terbesar yang ingin dicapai, dan bagaimana kamu memandang bisnis ini. Dari cerita kamu, saya akan bantu susun strategi yang paling sesuai.",
    summaryIntro: "Terima kasih sudah cerita banyak! 🙌 Ini ringkasan yang saya tangkap — cek dulu sebelum saya mulai analisis:",
    editLabel: "Edit",
...
const en: Translations = {
  ...
  chatFlow: {
    ...
    askEmail: "Nice to meet you! 😊 Could I get your email? Your payment receipt will be sent there.",
    askProfesi: "What's your role in this business? (e.g. Founder, Owner, Manager)",
    askNamaBisnis: "What's the name of your business or brand?",
    askJenisBisnis: "What industry is your business in? (e.g. Coffee Shop, Retail, Consulting)",
    askLokasiNew: "Where's your business planned to be located?",
    askLokasiRunning: "Where is your business located right now?",
    ...
    askTantanganNew: "What's the biggest challenge you're facing in starting this business?",
    askTantanganRunning: "What's your business's biggest challenge right now?",
    askTarget: "What's your biggest target or hope for this business in the next 6-12 months?",
    askCeritaVisi:
      "Last one — mind sharing something more personal? Tell me about your current situation, the biggest dream you want to achieve, and how you see business. From your story, I'll help craft the strategy that fits you best.",
    summaryIntro: "Thanks for sharing so much! 🙌 Here's what I've gathered — check it over before I start the analysis:",
    editLabel: "Edit",
